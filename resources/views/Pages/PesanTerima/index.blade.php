...
<div class="row gap-4">
    <div class="col-12">
        <div class="d-md-flex align-items-center justify-content-between">
            <div>
                <h4 class="m-md-0 text-md-start text-center">Manajemen Pemesanan dan Penerimaan Barang</h4>
                <span><em>Data diambil dari pesanan dan penerimaan oleh admin</em></span>
            </div>
        </div>
    </div>
    <div class="col-12 position-relative">
        <div class="card">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12">
                        <label for="filter">Filter Tanggal Pemesanan / Penerimaan</label>
...
@push('script')
    <script>
        $('#pesan-terima').addClass('active')

        var table = $('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('pesan-terima.index') }}",
                data: function(d) {
