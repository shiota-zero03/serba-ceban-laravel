...
<div class="row gap-4">
    <div class="col-12">
        <div class="d-md-flex align-items-center justify-content-between">
            <div>
                <h4 class="m-md-0 text-md-start text-center">Manajemen Penjualan Barang</h4>
                <span><em>Data diambil dari barang yang sudah diterima oleh admin</em></span>
            </div>
        </div>
    </div>
    <div class="col-12 position-relative">
        <div class="card">
            <div class="card-body">
                <div class="mb-4">
                    <label for="filter">Filter Tanggal Penerimaan</label>
