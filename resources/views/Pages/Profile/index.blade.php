...
<div class="row gap-4">
    <div class="col-12">
        <h4 class="m-md-0 text-md-start text-center">Edit Profile</h4>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="row g-2" action="{{route('profile.store')}}" method="POST">
                    @csrf
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="name">Nama</label>
                            <input type="text" class="form-control" name="name" placeholder="Masukkan nama disini" value="{{ $user['name'] }}">
                            @error('name')
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Masukkan email disini" value="{{ $user['email'] }}">
                            @error('email')
                                <small class="text-danger"><em>{{ $message }}</em></small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="whatsapp" placeholder="Masukkan whatsapp disini" value="{{ $user['phone_number'] }}">
                            @error('whatsapp')
                                <small class="text-danger"><em>{{ $message }}</em></small>
                            @enderror
                        </div>
